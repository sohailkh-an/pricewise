        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    these cookies as they are essential for the Service to work.
                  </p>
                  <p className="text-gray-600 text-sm mt-2">
                    Examples: Session cookies, authentication tokens, security
                    cookies
                  </p>
                </div>
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    choices, such as your preferred language, currency, or saved
                    searches. They help provide a more personalized experience.
                  </p>
                  <p className="text-gray-600 text-sm mt-2">
                ...
                <div className="border-l-4 border-red-500 pl-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    on our pages. We do not control these cookies and recommend
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      your browser. They help us maintain your session while you
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      until you delete them. They remember your preferences
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-gray-700">
                  <strong>Note:</strong> Blocking or deleting certain cookies
                  may affect your experience on PriceWise and limit some
                  functionality.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  ...
                  links to cookie management guides for popular browsers:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  <li>
            ...
            <section>
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-gray-700">Email: privacy@pricewise.com</p>
                <p className="text-gray-700">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-600 text-center">
              By continuing to use PriceWise, you consent to our use of cookies
